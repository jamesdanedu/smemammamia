...
| 4 | **Contact email.** `office@stmarysedenderry.ie` is a placeholder. | `config.js`, `EMAIL_REPLY_TO` |
...
Items 1, 2 and 4 are marked `// TODO` in `config.js`. Capacity changes made in
