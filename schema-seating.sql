...
--  build the same 504 ids from it. This table only records which of them are
...
--
--    seating.js lays out 504 seats a night. If capacity says something else,
--    either the last tickets cannot be seated or the last seats cannot be
--    sold, so keep the two in step.
-- ---------------------------------------------------------------------------
update public.performances set capacity = 504 where on_sale and capacity <> 504;
